...
public class drawFixedTexture extends MCH_HudItem{
    ...
    public drawFixedTexture(int fileLine, String name, String left, String top, String width, String height, String uLeft, String vTop, String uWidth, String vHeight, String rot) {
        super(fileLine);
        this.name = name;
    ...
    public void execute() {
      ...
      //  GL11.glEnable(3042);
       ...
       // this.drawFixedTexture(this.name, drawFixedTexture.centerX + calc(this.left), drawFixedTexture.centerY + calc(this.top), calc(this.width), calc(this.height), calc(this.uLeft), calc(this.vTop), calc(this.uWidth), calc(this.vHeight), (float) calc(this.rot), this.textureWidth, this.textureHeight);
        ///*
        try {
			this.drawFixedTexture(this.name, drawFixedTexture.centerX + calc(this.left), drawFixedTexture.centerY + calc(this.top), calc(this.width), calc(this.height), calc(this.uLeft), calc(this.vTop), calc(this.uWidth), calc(this.vHeight), (float) calc(this.rot), this.textureWidth, this.textureHeight);
