...
public class MCH_HudItemBulletSight extends MCH_HudItem {
    ...
    private PreEAClass peac;

    public MCH_HudItemBulletSight(int fileLine, String name, String left, String top, String width, String height, String uLeft, String vTop, String uWidth, String vHeight, String rot)
    {
        super(fileLine);
        this.name = name;
    ...
    public void execute()
    {
        ...
        this.drawBulletPoint(this.peac,this.name, centerX + calc(this.left), centerY + calc(this.top), calc(this.width), calc(this.height), calc(this.uLeft), calc(this.vTop), calc(this.uWidth), calc(this.vHeight), (float)calc(this.rot), this.textureWidth, this.textureHeight);
    }
}
