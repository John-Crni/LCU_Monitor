...
public class MCH_HudItemGraduation extends MCH_HudItem {
    ...
    public void execute() {
        GL11.glPushMatrix();
        int x = (int) (MCH_HudItemGraduation.centerX + calc(this.drawPosX));
        int y = (int) (MCH_HudItemGraduation.centerY + calc(this.drawPosY));
    ...
    private void drawCommonGraduationPitch1(double playerPitch,int color,int posX,int posY){
        ...
        this.drawLine(line, color);
        double[] adouble = new double[] { (double) (posX_L - 25), (double) (linePosY - 90), (double) posX_L, (double) (linePosY - 90), (double) posX_L, (double) (linePosY + 90), (double) (posX_L - 25), (double) (linePosY + 90)};

        this.drawLine(adouble, color, 3);
        adouble = new double[] { (double) (posX_R + 25), (double) (linePosY - 90), (double) posX_R, (double) (linePosY - 90), (double) posX_R, (double) (linePosY + 90), (double) (posX_R + 25), (double) (linePosY + 90)};
        this.drawLine(adouble, color, 3);
    }
