...
public class PreEAClass{
    ...
    private Vec3 lastLandInDistance;
    ...
    public Vec3 getLandInDistance(Entity user,int Alt,MCH_EntityAircraft AC)
        ...
        if (AC.getCountOnUpdate() % 4 == 0)
        {
            ...
            if (prm.user != null)
            {
                ...
                if (currentWs != null)
                {
                    ...
                    this.lastLandInDistance =MaingetLandInDistance(prm,currentWs,Alt);
                }
            }
        }
    ...
    public Vec3 MaingetLandInDistance(MCH_WeaponParam prm,MCH_WeaponSet ws,int Alt)
    {
        ...
        if (crtWpn1 != null && crtWpn1.getInfo() != null)
        {
            ...
            return this.Last_getLandInDistance(prm,crtWpn1,Alt);
        }
        else
        {
            return re;
    ...
    public Vec3 Last_getLandInDistance(MCH_WeaponParam prm,MCH_WeaponBase wb,int Alt)
    {
    	Vec3 re=Vec3.createVectorHelper(0, 0, 0);
            ...
            }else
            {
                ...
                for (int i = 0; i < Alt; ++i)
                {
                    ...
                    if ((mop != null &&(mop.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)))
                    {
                        ...
                        re.xCoord=mop.blockX;
                        re.yCoord=mop.blockY;
                        re.zCoord=mop.blockZ;
                        return re;
                    }
